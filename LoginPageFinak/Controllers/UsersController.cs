...
namespace LoginPageFinak.Controllers
{
    public class UsersController : Controller
    {
        private readonly LoginPageFinakContext _context;

        public UsersController(LoginPageFinakContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Login(User loginUser)
        {
            if (ModelState.IsValid)
            {
                ...
                if (user != null)
                {
                    ...
                    // Redirect to a different page or set authentication
            ...
            {
                ViewBag.Message = "Please fill in both fields.";
                ViewBag.IsSuccess = false;
            }
